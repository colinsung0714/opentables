...
Revision ID: 3c72e020ea79
Revises: 
Create Date: 2023-09-07 16:50:42.871748
...
def upgrade():
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('user_id', 'restaurant_id', name='unique_combination_constraint')
    )
